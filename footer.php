...
<!-- Jquery Mobile Menu -->
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.slicknav.min.js"></script>
...
<script src="<?=get_template_directory_uri()?>/assets/js/animated.headline.js"></script>
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.magnific-popup.js"></script>

<!-- Scrollup, nice-select, sticky -->
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.scrollUp.min.js"></script>
...
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.form.js"></script>
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.validate.min.js"></script>
<script src="<?=get_template_directory_uri()?>/assets/js/mail-script.js"></script>
<script src="<?=get_template_directory_uri()?>/assets/js/jquery.ajaxchimp.min.js"></script>
